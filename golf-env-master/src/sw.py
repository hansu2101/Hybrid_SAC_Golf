...
class SACagent(object):
    ...
    def load_weights(self, path):
        self.actor.load_weights(path + 'sactor_1.h5')
        self.critic.load_weights(path + 'scritic_1.h5')
    ...
    def train(self, max_episode_num):
        ...
        for ep in range(int(max_episode_num)):
            ...
            while not done:
                ...
                if ep > 1:  # start train after buffer has some amounts
            ...
            #print('Now save')
            self.actor.save_weights("../save_weights/sactor_2.h5")
            self.critic.save_weights("../save_weights/scritic_2.h5")
            # self.env.plot()
